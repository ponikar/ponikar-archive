...
export const FooterLeftSubSection = () => {
    ...
    <h2 className="text-lg mt-5 mb-2"> Links  </h2>
         { MenuData.map((menu, index) => <FooterLink {...menu} key={index} />) }
    </div>
}
...
export const FooterLeftInputSection = () => {
    ...
    <h2 className="text-lg mt-5 mb-2"> Follow ME  </h2>
         <div className="flex items-center">
            <a target="_blank" href="https://twitter.com/PonikarDarshan"><Twitter fill="#fff" /></a>
            <a target="_blank" href="https://instagram.com/iponikar"  className="ml-3"> <Instagram fill="#fff" /></a>
            <a target="_blank" href="https://www.linkedin.com/in/darshan-ponikar-aa89691a3/"  className="ml-3"> <Linkedin fill="#fff" /></a>
         </div>
        <FooterSubscribe />
    </div>
}
