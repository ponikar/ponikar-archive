...
import { BlogProps, CreateBlogContext, CREATE_BLOG_INITIAL_STATE } from "../../../src/Context/create-blog.context";
...
const UpdateBlog:FC = () => {
    ...
    const getBlog = useCallback(async blog_id => {
        try {
